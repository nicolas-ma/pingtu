...
(EventEmitter.prototype.addListener = function (a, b) {
  if (typeof b !== 'function') throw new Error('addListener only takes instances of Function')
...
(EventEmitter.prototype.once = function (a, b) {
  ...
  if (typeof b !== 'function') throw new Error('.once only takes instances of Function')
  var c = this
  return (d.listener = b), c.on(a, d), this
}),
(EventEmitter.prototype.removeListener = function (a, b) {
  if (typeof b !== 'function') throw new Error('removeListener only takes instances of Function')
